...
import type { Studio } from '@/types/rhapsody';
...
export function StudioCard({ studio, featured = false }: StudioCardProps) {
    return (
        <article
            className={[
                'group relative isolate overflow-hidden rounded-lg border border-border bg-card',
        ...
        >
            ...
            <div className="relative flex h-full min-h-[inherit] flex-col justify-end p-5 md:p-6">
                <span className="mb-4 w-fit rounded-full bg-primary px-3 py-1 text-[11px] font-extrabold tracking-tight text-primary-foreground uppercase">
                    {studio.tier}
                </span>
                <div className="flex items-end justify-between gap-4">
                    ...
                    <button
                        ...
                        className="grid size-12 place-items-center rounded-md border border-primary/20 bg-black/30 text-white transition group-hover:border-primary"
                    >
