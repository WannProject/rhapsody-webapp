...
export const navItems: NavItem[] = [
    ...
    { view: 'booking', label: 'Bookings', icon: ReceiptText },
    { view: 'payment', label: 'Payment', icon: CreditCard },
    { view: 'admin', label: 'Admin', icon: BarChart3 },
];
